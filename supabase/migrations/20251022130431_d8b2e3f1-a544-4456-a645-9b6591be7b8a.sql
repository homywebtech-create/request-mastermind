...
DO $$
BEGIN
  PERFORM cron.unschedule('notify-expired-orders');
EXCEPTION
  WHEN OTHERS THEN
...
COMMENT ON FUNCTION check_and_notify_expired_order() IS 'Instantly notifies specialists when an order expires - fires immediately via trigger';