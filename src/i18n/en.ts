export const en = {
  ...
  specialist: {
    ...
    paymentConfirmationTitle: "💰 Confirm Payment Receipt",
    paymentMatchQuestion: "Does the amount paid by the customer match the invoice amount?",
    yesAmountMatches: "✅ Yes, Amount Matches",
    noDifferentAmount: "⚠️ No, Different Amount",
    enterReceivedAmount: "💵 Enter Received Amount",
    actualAmountReceived: "Actual Amount Received",
    enterAmount: "Enter amount",
    extraAmountReason: "Was the extra amount due to one of the following reasons?",
    tipFromCustomer: "💰 Tip from Customer",
    saveInWallet: "💳 Customer Wants to Save in Wallet",
    noChangeToReturn: "💵 Don't Have Change to Return",
    otherReason: "📝 Other Reason",
    specifyReason: "Specify Reason",
    writeReasonHere: "Write reason here...",
    ...
    paymentConfirmationError: "❌ Error",
    paymentConfirmationErrorDesc: "Failed to confirm payment. Try again",
    enterValidAmount: "Please enter a valid amount",
    selectDifferenceReason: "Please select a reason for the difference",
    writeReason: "Please write the reason",
    ...
    otherPaymentReason: "Other (specify reason)",
    finishWorkNow: "Finish Work Now",
    extendWorkTime: "Extend Work Time",
    writePaymentReason: "Write the reason",
